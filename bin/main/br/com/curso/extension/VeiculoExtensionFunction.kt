...
fun CadastrarVeiculoCommand.toDomain() : Veiculo{
    return Veiculo(null, this.modelo, this.marca, this.anoFabricacao, this.anoModelo, this.placa, this.valor)
}
fun CadastrarVeiculoRequest.toCommand() : CadastrarVeiculoCommand{
    return CadastrarVeiculoCommand(this.modelo, this.marca, this.anoFabricacao, this.anoModelo, this.placa, this.valor)
}
...
fun VeiculoQueryResponse.toResponse() : VeiculoResponse{
    return VeiculoResponse(this.id, this.modelo, this.marca, this.anoFabricacao, this.anoModelo, this.placa, this.valor)
}
...
fun VeiculoModel.toQueryResponse() : VeiculoQueryResponse{
    return VeiculoQueryResponse(this.id!!, this.modelo, this.marca, this.anoFabricacao, this.anoModelo, this.placa, this.valor)
}
